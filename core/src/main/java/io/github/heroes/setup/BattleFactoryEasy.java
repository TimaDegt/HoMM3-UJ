...
public class BattleFactoryEasy {
    ...
    public static BattleEngine createDemoBattle() {
        ...
        playerOneArmy.addUnit(new ArcherUnitStack(10, new Position(1, 9), Player.PLAYER_ONE));
        playerOneArmy.addUnit(new ArcherUnitStack(2, new Position(1, 1), Player.PLAYER_ONE));
        playerOneArmy.addUnit(new DefaultUnitStack(UnitType.CAVALIER, 2, new Position(1, 11), Player.PLAYER_ONE));
